<div align="center">
  ...
  <p>
    <img src="https://img.shields.io/badge/version-26.8.13.0221-25D9C5?style=flat-square" alt="Version 26.8.13.0221">
...
> 如果“应用程序”中同时存在 `NotchTriage.app` 与旧的 `Notch Triage.app`，请先退出两者，再用 v26.8.13.0221 的 `NotchTriage.app` 覆盖并移除旧的空格命名副本，避免同一 Bundle ID 启动两个实例。
